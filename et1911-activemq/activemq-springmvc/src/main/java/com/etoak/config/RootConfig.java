...
@Configuration
@ComponentScan(basePackages = {"com.etoak"}, includeFilters = {@Filter(type =
  FilterType.ANNOTATION, classes= {Service.class,Repository.class})},
  excludeFilters = {@Filter(type=FilterType.ANNOTATION, classes=
  {Controller.class,RestController.class,ControllerAdvice.class,EnableWebMvc.
  class})} )
...
public class RootConfig {
	...
	public SqlSessionFactoryBean sqlFactory() {
		...
		//数据源、typeAliasesPackage、plugins
